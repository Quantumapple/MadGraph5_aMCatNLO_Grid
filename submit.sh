...
./install.py --carddir Cards/darkHiggs_Monohs_LO_MZprime_Mhs_Mchi_13TeV-madgraph --proc 405 --gq 0.25 --gdm 1.001 --hdm 50 --med 2000 --dm 100 --runcms runcmsgrid_LO.sh 

#406 -> darkHiggs Mono-Z'
./install.py --carddir Cards/darkHiggs_MonoZp_LO_MZprime_Mhs_Mchi_13TeV-madgraph --proc 406 --gq 0.25 --gdm 1.001 --hdm 150 --med 2000 --dm 50 --runcms runcmsgrid_LO.sh
